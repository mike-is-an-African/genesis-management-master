    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mb-16 max-w-3xl">
          <h2 className="text-4xl md:text-5xl font-playfair tracking-tight mb-6 text-genesis-navy relative">
...
function CaseStudyItem({ caseStudy, index }: { caseStudy: CaseStudyData; index: number }) {
        ...
        <div className="relative h-full overflow-hidden">
          <div className="aspect-[4/3] relative overflow-hidden bg-zinc-100 group rounded-sm">
            ...
            <div className={cn(
              ...
              isEven ? "right-6 bg-genesis-gold/90 text-white" : "left-6 border-l-2 border-genesis-gold bg-white/80 text-genesis-navy"
            )}>
              {caseStudy.industry}
            </div>
          </div>
        ...
        <div className="max-w-xl mx-auto lg:mx-0 flex flex-col h-full">
          <div className={cn(
            ...
            <h3 className={cn(
              ...
              isEven ? "border-r-2 border-genesis-gold/40 pr-6 lg:text-right" : "border-l-2 border-genesis-gold/40 pl-6",
            )}>
              {caseStudy.title}
            </h3>
              ...
              >
                ...
                <ArrowRight 
                  className={cn(
                    ...
                    isEven ? "mr-2 rotate-180 group-hover:-translate-x-2" : "ml-2"
                  )} 
                />
              </Link>
            </div>
